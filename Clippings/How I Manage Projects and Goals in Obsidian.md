...
url: "https://bagerbach.com/blog/projects-and-goals-obsidian/#how-it-works"
created: 2026-07-21
...
![Fictional goals on a Kanban board](https://bagerbach.com/uploads/obsidian_fictious_goals.png)

Fictional goals on a Kanban board

You get a Kanban overview (as seen in the image above) as well as a dashboard for your goals and projects.

![Dashboard](https://bagerbach.com/uploads/projects_goals_dashboard.png)
...
![MetaEdit Settings](https://bagerbach.com/uploads/projects_goals_kanban_helper.png)
...
![Macros](https://bagerbach.com/uploads/proj_goals_metaedit_settings.png)
...
![Add Goal](https://bagerbach.com/uploads/proj_goals_quickadd_add_goal.png)
...
##### Configuring Add Project

You’ll be doing something very similar here, so I’ll show you what mine looks like, and you can set yours accourdingly.

The macro:

![Add Project Macro](https://bagerbach.com/uploads/proj_goals_add_project.png)

Add Project Macro

The `Create Project Note` step:

![Create Project Note](https://bagerbach.com/uploads/proj_goals_create_project_note.png)
...
In [How it works](#how-it-works), I’ll describe how everything works behind-the-scenes.
